              ...
              <tbody>
                {filtered.map((i) => {
                  ...
                  return (
                    <tr
                      key={i.id}
                      className="border-b border-slate-50 transition-colors last:border-0 hover:bg-slate-50 dark:border-white/[0.03] dark:hover:bg-white/[0.02]"
                    >
                      <td className="px-4 py-3">
                        <div className="flex items-center gap-3">
                          <div className="grid h-9 w-9 shrink-0 place-items-center rounded-lg bg-volt-500/10 text-volt-500">
                      ...
                      <td className="px-4 py-3 tabular-nums text-slate-500 dark:text-slate-400">
                        {formatRD(i.costPrice, { decimals: false })}
                      </td>
                      <td className="px-4 py-3 font-medium tabular-nums">
                        {formatRD(i.salePrice, { decimals: false })}
                      </td>
                      <td className="px-4 py-3">
                      ...
                      <td className="px-4 py-3 text-right">
                        <div className="flex items-center justify-end gap-2">
                          {low && (
                            <Badge className="bg-amber-50 text-amber-700 ring-amber-500/25 dark:bg-amber-500/15 dark:text-amber-300">
