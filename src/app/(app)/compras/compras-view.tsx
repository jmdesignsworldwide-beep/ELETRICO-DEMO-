...
function NewPOModal({ suppliers, inventory, onClose }: { suppliers: Supplier[]; inventory: InventoryItem[]; onClose: () => void }) {
  ...
  return (
    <>
      ...
      <motion.div initial={{ opacity: 0, y: 24, scale: 0.97 }} animate={{ opacity: 1, y: 0, scale: 1 }} exit={{ opacity: 0, y: 24, scale: 0.97 }} transition={{ type: "spring", stiffness: 320, damping: 30 }} className="fixed inset-0 z-50 m-auto h-fit max-h-[92vh] w-[92vw] max-w-xl overflow-y-auto">
