              ...
              <div className="flex flex-wrap items-center gap-4">
                ...
                <div className="min-w-0 flex-1">
                  <div className="flex items-center gap-2">
                    ...
                    <Badge className={quoteStatusStyle[q.status]}>
                ...
                <div className="flex w-full items-center gap-2 border-t border-slate-100 pt-3 dark:border-white/[0.06] sm:w-auto sm:border-0 sm:pt-0">
                  <button className="btn-ghost flex-1 px-3 py-2 text-xs sm:flex-none">
                    <Share2 className="h-3.5 w-3.5" />
                    WhatsApp
                  </button>
                  {q.status === "aprobada" && (
                    <button className="btn-primary flex-1 px-3 py-2 text-xs sm:flex-none">
